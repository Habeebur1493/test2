      ...
      <div className="container1">
        ...
        <div className="column2">
          ...
          <div className="item-list" >
            ...
            <Link to="/products/clothing/clothingdetails" className="item2">
              <img src="https://rukminim2.flixcart.com/image/850/1000/xif0q/t-shirt/i/m/m/m-ustshs1534-u-s-polo-assn-original-imags7tspgvfcemp.jpeg?q=90&crop=false" alt="" />
              <h1>Polo T Shirt</h1>
              <p>Red</p>
              <h2>₹200.00</h2>
            </Link>
            <Link to="/products/clothing/clothingdetails" className="item3">
              <img src="https://rukminim2.flixcart.com/image/850/1000/xif0q/t-shirt/i/m/m/m-ustshs1534-u-s-polo-assn-original-imags7tspgvfcemp.jpeg?q=90&crop=false" alt="" />
              <h1>Polo T Shirt</h1>
              <p>Red</p>
              <h2>₹200.00</h2>
            </Link>
            <Link to="/products/clothing/clothingdetails" className="item4">
              <img src="https://rukminim2.flixcart.com/image/850/1000/xif0q/t-shirt/i/m/m/m-ustshs1534-u-s-polo-assn-original-imags7tspgvfcemp.jpeg?q=90&crop=false" alt="" />
              <h1>Polo T Shirt</h1>
              <p>Red</p>
              <h2>₹200.00</h2>
