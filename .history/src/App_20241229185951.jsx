...
import  ClothingDetails from "./Frontend/Firstpage/ClothingDetails";
import ProductView from "./Frontend/Firstpage/ProductView"; 
...
const App = () => {
  const banners = [
    ...
    "https://graphicsfamily.com/wp-content/uploads/2020/07/Shoes-Advertising-Banner-Design-Template-1536x864.jpg",
  ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/products/:category" element={<ClothingDetails />} />
        <Route path="/products/Clothing/:category" element={<ProductView />} />
